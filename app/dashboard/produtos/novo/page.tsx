  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `O produto "${formData.name}" foi adicionado ao sistema.`,
      })
          ...
          <TabsContent value="additional" className="space-y-6">
            ...
            {formData.name && formData.price && (
              <Alert>
                ...
                <AlertDescription>
                  <p>
                    O produto <strong>{formData.name}</strong> será cadastrado com preço de venda de{" "}
                  ...
                  {formData.currentStock && Number(formData.currentStock) > 0 && (
                    <p className="mt-1">
                      Estoque inicial: {formData.currentStock} {formData.unit} | Valor em estoque:{" "}
